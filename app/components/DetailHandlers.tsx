...
interface DetailsHandlersProps {
  ...
  setShowCardPicker: (value: boolean) => void;
  selectedCardId: number;
  setSelectedCardId: (value: number) => void;
}

/**
 * Handlers for the DetailsScreen
 */
export const DetailsHandlers = (props: DetailsHandlersProps) => {
  const {
    transaction,
    transactionIndex,
    isEditing,
...
/**
 * Export default styles for the DetailsScreen components
 */
export const styles = {
  container: {
    flex: 1,
